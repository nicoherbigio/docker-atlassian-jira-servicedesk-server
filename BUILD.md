...
```
# Build the Docker image
docker build --no-cache --pull --tag nicoherbigde/atlassian-jira-servicedesk-server:4.20 4.20/ubuntu/default
```
...
docker push nicoherbigde/atlassian-jira-servicedesk-server:4.20
```
