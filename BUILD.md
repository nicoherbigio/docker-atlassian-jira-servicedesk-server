# Building instructions for the Atlassian Jira Servicedesk Server Docker image
...
```
# Build the Docker image
docker build --no-cache --pull --tag nicoherbigde/atlassian-jira-servicedesk-server:4.20-jammy 4.20/ubuntu/default
```
...
docker push nicoherbigde/atlassian-jira-servicedesk-server:4.20-jammy
```
